...
job = cron.new(command='/path/to/venv/bin/python /path/to/europarl/retrieve_tweets.py GR >> /path/to/log/retrieve_tweets.log 2>&1',
               comment="Save the GR MEPs tweets and the replies")
